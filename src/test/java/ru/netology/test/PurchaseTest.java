...
public class PurchaseTest {
    ...
    public void shouldBeSuccessCurrentMonthAndYearPayment() {
        ...
        assertTrue(SqlHelper.checkApprovedPayment(), "Строка не найдена");
    }
    ...
    public void shouldBeDeclinedValidCardPayment() {
        ...
        assertTrue(SqlHelper.checkDeclinedPayment(), "Строка не найдена");
    }
    ...
    public void shouldBeSuccessCurrentMonthAndYearCredit() {
        ...
        assertTrue(SqlHelper.checkApprovedCredit(), "Строка не найдена");
    }
